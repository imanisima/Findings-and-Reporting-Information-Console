...
export default function ConfirmArchiveDialog(props) {
	return (
		<Dialog
			open={props.isOpen}
		...
		>
			<DialogTitle id="scroll-dialog-title" style={{ textAlign: "center" }}>Archive {props.objectType}(s)</DialogTitle>
			<DialogContent dividers={true}>
				<Typography variant="subtitle1">Are you sure you want to archive {(props.numSelected != null && props.numSelected > 1) ? props.numSelected + ` ${props.objectType}s` : ` this ${props.objectType}`}?</Typography>
			</DialogContent>
			<DialogActions>
